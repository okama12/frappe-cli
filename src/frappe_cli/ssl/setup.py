"""`frappe ssl setup` — install a Let's Encrypt certificate for an existing site.
...
def setup(site_name: str, bench_name: str, email: str, force: bool) -> None:
    ...
    Examples:
        frappe ssl setup --site-name test5.rashidiokama.com
        frappe ssl setup --site-name site.example.com --bench-name my-bench
        frappe ssl setup --site-name site.example.com --email me@example.com
    """
